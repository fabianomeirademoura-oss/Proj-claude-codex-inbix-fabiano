...
funil e estoque). Esta pasta (`painel-horizonte/`) é a **raiz oficial**. O Codex
trabalha no mesmo projeto, com as instruções em [AGENTS.md](AGENTS.md).

## Leia antes de qualquer tarefa

1. **[COORDENACAO.md](COORDENACAO.md):** o acordo de trabalho com o Codex e o
   registro de tarefas. Consulte as tarefas em andamento e **registre a sua
   antes de editar**.
...
executadas, as limitações e os impactos para o Codex.
